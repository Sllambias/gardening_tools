...
from gardening_tools.functional.transforms.sampling import numpy_simulate_lowres, torch_simulate_lowres
...
class Numpy_SimulateLowres(BaseTransform):
    ...
    def __simulatelowres__(self, image, target_shape):
        image = numpy_simulate_lowres(image, target_shape=target_shape, clip_to_input_range=self.clip_to_input_range)
        return image
